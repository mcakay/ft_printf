...
void	ft_sign_control(t_print **print)
{
	if ((*print)->plus)
		(*print)->val_len++;
	if ((*print)->plus && !(*print)->precision && (*print)->dval >= 0 && (*print)->spec == 'd')
		ft_putchar_rtn(print, '+', 1);
	else if ((*print)->plus && !(*print)->precision && (*print)->dval >= 0 && (*print)->spec == 'i')
		ft_putchar_rtn(print, '+', 1);
	else if ((*print)->plus && !(*print)->precision && (*print)->spec == 'u')
		ft_putchar_rtn(print, '+', 1);
	if ((*print)->space && !(*print)->precision && (*print)->dval >= 0 && (*print)->spec == 'd')
		ft_putchar_rtn(print, ' ', 1);
	else if ((*print)->space && !(*print)->precision && (*print)->dval >= 0 && (*print)->spec == 'i')
		ft_putchar_rtn(print, ' ', 1);
